...
<div id="tb">
    <div>
        ...
        <a href="javascript:doGrant()" class="easyui-linkbutton" iconCls="icon-remove" plain="true">授权</a>
    </div>
    <div>
...
<div id="menus" class="easyui-dialog" style="width:400px;height:300px;padding: 10px 20px"
     closed="true" >

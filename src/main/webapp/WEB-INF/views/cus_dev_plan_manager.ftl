...
<head>
    ...
    <script type="text/javascript" src="${ctx}/static/js/cus.dev.plan.manager.js"></script>
</head>
...
<div id="p" class="easyui-panel" title="销售机会信息" style="width: 700px;height: 350px;padding: 10px">
    <table cellspacing="8px">
        ...
        <input type="hidden" id="devResult" name="devResult" value="${saleChance.devResult}"/>
        <tr>
            <td>客户名称：</td>
        ...
        <tr>
            <td>概要：</td>
            <td colspan="4"><input type="text" id="overview" name="overview" readonly="readonly" value="${saleChance.overview?if_exists}"/></td>
        </tr>
        <tr>
            <td>机会描述：</td>
            <td colspan="4">
...
<table id="dg" title="开发计划项" style="width:700px;height:250px"
    ...
    <tr>
        ...
        <th field="planDate" name="planDateStr" width="80" editor="{type:'datebox',options:{required:true,editable:false}}">日期</th>
        <th field="planItem" width="80" editor="{type:'validatebox',options:{required:true}}">计划内容</th>
        <th field="exeAffect" width="80" editor="{type:'validatebox',options:{required:true}}">执行效果</th>
    </tr>
    </thead>
</table>

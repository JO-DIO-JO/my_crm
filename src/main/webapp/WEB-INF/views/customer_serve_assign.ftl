...
<table id="dg"  class="easyui-datagrid"
       ...
       url="${ctx}/customer_serve/list?state=fw001" fit="true" toolbar="#tb" singleSelect="true">
    <thead>
    <tr>
...
<div id="tb">
    <div>
        <a href="javascript:openCustomerServeAssignDialog()" class="easyui-linkbutton" iconCls="icon-add" plain="true">分配</a>
    </div>
    <div>

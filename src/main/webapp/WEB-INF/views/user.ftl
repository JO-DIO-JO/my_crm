...
<table id="dg"  class="easyui-datagrid"
    ...
    <tr>
        ...
        <th field="createDate" width="175" align="center">创建时间</th>
        <th field="updateDate" width="175" align="center" >更新时间</th>
    </tr>
    </thead>
</table>
<div id="tb">
...
<div id="dlg" class="easyui-dialog" style="width:720px;height:360px;padding: 10px 20px"
    ...
    <form id="fm" method="post">
        <table cellspacing="8px">
            ...
            <tr>
                <td>角色：</td>
                <td>
                    <input id="cc" class="easyui-combobox" name="roleIds" valueField="id" textField="roleName"
                        style="width: 240px" multiple="true" url="${ctx}/role/queryAllRoles" panelHeight="auto" />
                </td>
            </tr>
        </table>

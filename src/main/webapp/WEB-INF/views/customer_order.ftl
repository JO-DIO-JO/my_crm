...
<#-- 客户信息详情展示 -->
<div id="p" class="easyui-panel" title="客户信息" style="width: 1000px; height: 130px; padding: 10px">
...
<table id="dg"  class="easyui-datagrid"
       ...
       url="${ctx}/customer_order/list?cusId=${customer.id}"toolbar="#tb"
       style="width: 1000px; height: 360px; padding: 10px" title="订单列表展示" toolbar="#tb" >
    <thead>
    <tr>

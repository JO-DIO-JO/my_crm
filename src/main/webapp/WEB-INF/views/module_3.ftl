...
<table id="dg"  class="easyui-datagrid"
       ...
       url="${ctx}/module/list?grade=2&parentId=${parentId}" fit="true" toolbar="#tb"  singleSelect="true">
    <thead>
    <tr>
        <th field="cb" checkbox="true" align="center"></th>
        <th field="id" width="50" align="center">编号</th>
        <th field="moduleName" width="150" align="center" >菜单名</th>
        ...
        <th field="optValue" width="50" align="center">权限码值</th>
        <th field="orders" width="50" align="center">排序</th>
        <th field="createDate" width="180" align="center">创建时间</th>
        <th field="updateDate" width="180" align="center" >更新时间</th>
    </tr>
    </thead>
</table>
<div id="tb">

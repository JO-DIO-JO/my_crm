...
<table id="dg" class="easyui-datagrid"
    ...
    <tr>
        ...
        <th field="name" width="100" align="center">客户名</th>
        ...
        <th field="state" width="50" align="center" formatter="formatterState">流失状态</th>
    </tr>
    </thead>
    ...
    <tr>
        ...
        <th field="xyd" width="100" align="center">信用度</th>
        <th field="address" width="100" align="center">详细地址</th>
        <th field="postCode" width="50" align="center">邮编</th>
        <th field="phone" width="100" align="center">电话</th>
        <th field="web_site" width="100" align="center">网站</th>
        <th field="fax" width="100" align="center">传真</th>
        <th field="yyzzzch" width="100" align="center">营业执照</th>
        <th field="khyh" width="100" align="center">开户行</th>
        <th field="khzh" width="50" align="center">开户账号</th>
        <th field="gsdjh" width="100" align="center">国税</th>
        <th field="dsdjh" width="100" align="center">地税</th>
...
<div id="tb">
    ...
    <div>
        ...
        <br/>
        信用度：
        <select class="easyui-combobox" id="s_xyd" editable="false" panelHeight="auto">
    ...
    <form id="fm" method="post">
        <table cellspacing="8px">
            <tr>
                ...
                <td>法人代表：</td>
                <td >
                    <input type="text" id="fr" name="fr" class="easyui-validatebox" required="true" />
                    <font color="red">*</font>
                </td>
            </tr>
            <tr>
